...
void WatchTft::settings_screen()
{
    ...
    if (pdTRUE == xSemaphoreTake(xGuiSemaphore, 1000))
    {
        ...
        lv_obj_t *label_title_tmo_off = lv_label_create(settings_bg);
        ...
        label_desc_tmo_off = lv_label_create(settings_bg);
        ...
        lv_obj_t *slider_tmo_off = lv_slider_create(settings_bg);
        lv_obj_align(slider_tmo_off, LV_ALIGN_TOP_MID, 0, 40);
        lv_obj_set_size(slider_tmo_off, 180, 20);
        ...
        lv_obj_t *label_title_wakeup = lv_label_create(settings_bg);
        ...
        lv_obj_t *label_desc_wakeup_01 = lv_label_create(settings_bg);
        ...
        lv_obj_t *cb_wakeup_double_tap = lv_checkbox_create(settings_bg);
        ...
        lv_obj_t *label_desc_wakeup_02 = lv_label_create(settings_bg);
        ...
        lv_obj_t *cb_wakeup_tilt = lv_checkbox_create(settings_bg);
        ...
        lv_obj_t *hor_bar_02 = lv_obj_create(settings_bg);
